...
echo "1⃣  Testing Database CRUD Operations..."
...
# Test 2: End-to-End
echo "2⃣  Testing End-to-End Workflow..."
...
if [ $? -eq 0 ]; then
    ...
    echo "  API Server: Not running (start with: ./scripts/start_backend.sh)"
fi
echo ""
